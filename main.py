...
def main():
    ...
    while True:
        ...
        if running:
            ...
            #draw the buttons
            pygame.draw.rect(screen, (255, 0, 0), (25, SCREEN_HEIGHT * SCALE - 75, 100, 50), 0)
            pygame.draw.rect(screen, (0, 0, 255), (SCREEN_WIDTH * SCALE - 125, SCREEN_HEIGHT * SCALE - 75, 100, 50), 0)
